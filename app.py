...
# Set Up Jinga2 template engine for rendering HTML templates templates
templates = Jinja2Templates(directory='templates')

# Allow all origins for Cross-Origin Resource Sharing (CORS)
origins = ["*"]

# Configure middlewares to handle CORS, allowing requests from any origin
app.add_middleware(
...
class DataForm:
    """
        ...
        This class defines the vehicles-related attributes expected from the form.
    """
    ...
    async def get_vehicle_data(self):
        ...
        self.Vehicle_Age_gt_2_Years = form.get("Vehicle_Age_gt_2_Year")
...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        # Make a prediction and retrieve results
