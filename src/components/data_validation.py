...
class DataValidation:
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        Description : This method validates the existence of a numerical & categorical columns

        Output: Returns bool value based on vaildation results
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        """
            ...
            Description: This metod initiates the data validation component for the pipeline
        ...
        try:
            ...
            # Validating co, dtype for train/test df
            ...
            # Save validation status & message to a JSON file
            validation_report = {
                "validation_status": validation_status,
