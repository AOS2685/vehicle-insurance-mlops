# import boto3
# import os
# from src.constants import AWS_SECRET_ACCESS_KEY_ENV_KEY, REGION_NAME, AWS_ACCESS_KEY_ID_ENV_KEY
...
#             # __access_key_id = os.getenv(AWS_SECRET_ACCESS_KEY_ID_ENV_KEY)
...
class S3Client:
    ...
    def __init__(self, region_name=REGION_NAME):
        """
        This class gets AWS credentials from environment variables and connects to S3.
        """
