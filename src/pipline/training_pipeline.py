...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        # This method of TrainPipeline class is reponsible for starting data ingestion component
        try:
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        #  This method of TrainPipeline class is responsible for startingdata validation component
        ...
        try:
            ...
            logging.info("Excited the start_data_validation method of TrainPipeline class")
    ...
    def start_model_trainer(self,data_transforamtion_artifact: DataTransformationArtifact) -> ModelTrainerArtifact:
        # This method of Train Pipeline class is responsible for starting model training
        try:
            model_trainer = ModelTrainer(data_transformation_artifact=data_transforamtion_artifact,
    ...
    def run_pipeline(self, ) ->None:
        ...
        try:
            ...
            model_trainer_artifact = self.start_model_trainer(data_transforamtion_artifact=data_transformation_artifact)
